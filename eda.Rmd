...
author: "Steven Ge (No restrictions to reuse or modify)"
date: "`r Sys.Date()`"
output: 
  html_document:
...
This RMarkdown document was written by [Steven Ge](https://www.linkedin.com/in/steven-ge-ab016947/), assisted heavily by GPT-4 (who wrote 90% of the code). Source code on [GitHub.](https://github.com/gexijin/gEDA) No guarantees. No right reserved.  
